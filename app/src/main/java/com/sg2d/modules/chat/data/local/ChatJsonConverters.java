...
public class ChatJsonConverters {
    @TypeConverter
    public GetChatEntryApiResponse.MessageContent gsonToMessage(String json) {
        return new Gson().fromJson(json, GetChatEntryApiResponse.MessageContent.class);
    }

    @TypeConverter
    public String MessageToGson(GetChatEntryApiResponse.MessageContent city) {
